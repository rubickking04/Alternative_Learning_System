    ...
    <div class="col-6 d-flex flex-row-reverse">
        <div class="text-end"  style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item roboto">Tables</li>
                <li class="breadcrumb-item active roboto">Teachers Table</li>
            </ol>
        </div>
    </div>
</div>
                    ...
                    <div class="col-lg-11 col-12">
                        <div class="row border-bottom border-2 border-dark">
                            <div class="col-lg-8 col-md-7 col-sm-6 col-6 d-none d-sm-block">
                                <div class="text-start py-3 fs-4 fw-bold card-title roboto">{{ __('Teachers Table') }}
                                </div>
                            </div>
                                            ...
                                            @if (session('msg'))
                                                <div class="col-lg-12 py-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text fw-bold text-center roboto text-muted">{{ __('Sorry, but the query you were looking for was either not found or does not exist.') }} </p>
                                                        <div class="row justify-content-center">
                                                    ...
                                                    <tbody>
                                                        @foreach ($teacher as $users)
                                                            <tr>
                                                                ...
                                                                <td  class="text-start roboto fw-bold h6 py-3 text-truncate" scope="row">{{ $users->name }}</td>
