        ...
        <div class="offcanvas w-auto offcanvas-start text-center" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasExampleLabel">
            <div class="offcanvas-header text-center">
                <h6 class="offcanvas-title" id="offcanvas">
                    ...
                    <a class="nav-link"><span class="text-info d-flex justify-content-center text-muted text-uppercase small px-5 roboto">{{ __('Administrator\'s Name') }}</span>
                    </a>
                </h6>
            </div>
            <hr>
            <div class="offcanvas-body text-dark px-0 ">
                <ul class="nav nav-pills flex-column mb-sm-auto mb-auto mb-0 align-items-start" id="menu">
                    <li class="nav-item">
                        <a class="nav-link"><span class="text-white text-muted text-uppercase small roboto">{{ __('Interface') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
