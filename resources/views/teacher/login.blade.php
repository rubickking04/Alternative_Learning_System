    ...
    <div class="row justify-content-center">
        <div class="col-xl-5">
            <div class="py-3">
                ...
                <hr>
                <h3 class="text-center py-4 fw-bold text-uppercase" style="letter-spacing: 3px">{{ __('Teacher Login Account') }}</h3>
                ...
                <hr>
                <div class="text-center">
                    <p>Not a member yet? <a href="{{ route('teacher.register') }}">{{ __('Sign up') }}</a></p>
                </div>
            </div>
        </div>
    </div>
