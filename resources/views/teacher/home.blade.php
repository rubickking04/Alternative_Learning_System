                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-8 col-lg-9 col-md-9 col-sm-9 col-9">
                            <a href="{{ route('teacher.class.home', $classes->uuid) }}" class="text-start d-block text-truncate h4 fw-bolder text-dark card-title">{{ $classes->description }}</a>
                            <h5 class="text-start fw-bold card-text " >{{ __($classes->yearLevel.' - ' .$classes->section) }}</h5>
                            <div class="row">
                                <div class="col-lg-12">
                                    <h5 class="text-start card-text py-2">{{ Auth::guard('teacher')->user()->name }}</h5>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-end px-3">
                        <div class="hstack gap-3">
                            <a href="{{ route('teacher.destroy', $classes->id) }}" onclick="return confirm('All the records here will be permantly deleted. Are you sure to remove this subject? ')" class="text-danger text-end " ><i class="fa-solid fa-trash-can fs-3"></i></a>
                        </div>
                    </div>
                </div>
            </div>
