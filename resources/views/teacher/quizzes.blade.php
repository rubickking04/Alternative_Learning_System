                        ...
                        <div class="card-title">
                            <div class="row border-bottom border-2 border-primary">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-10 mb-2">
                                    ...
                                    <p class="small text-muted lh-sm">{{ Auth::guard('teacher')->user()->name.' • '. \Carbon\Carbon::parse($created_at)->format('h:i a') }}</p>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end " scope="row">
                                                    ...
                                                    <ul class="dropdown-menu " aria-labelledby="navbarDarkDropdownMenuLink">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{ route('teacher.remove.answer', $lessons->id) }}" onclick="return confirm('AAre you sure to remove this student? ')"><i class="fa-solid fa-rotate-left px-2"></i>{{ __('Return') }}</a></li>
                                                        @endif
                                                    </ul>
