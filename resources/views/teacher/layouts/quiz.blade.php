    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container-fluid px-4">
                ...
                {{-- <p class=" small">{{ __('Alternative Learning System') }}</p> --}}
                <ul class="navbar-nav me-5 mx-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active px-4 d-none text-uppercase d-md-block" href="{{ URL::previous() }}">{{ __('Instruction') }}</a>
                    </li>
                        <a class="nav-link active px-4 d-none text-uppercase d-md-block" href="#">{{ __('Ranking') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active px-4 d-none text-uppercase d-md-block" href="{{ route('teacher.turnin',$id) }}">{{ __('Turned in') }}</a>
                    </li>
        ...
        <nav class="navbar navbar-expand navbar-light fixed-bottom bg-white shadow-sm d-block d-sm-none " aria-label="Second navbar example">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample02">
                <ul class="navbar-nav mx-auto text-center">
                    <li class="nav-item">
                        <a class="nav-link active px-3" aria-current="page" href="{{ URL::previous() }}">
                            <i class="fs-4 bi bi-chat-left-text-fill px-3 mt-2"></i>
                            <span class="px-1 text-uppercase">{{ __('Instruction') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 active" href="#">
                            <i class="fs-4 fa-solid fa-ranking-star px-3 mt-2"></i>
                            <span class="px-1 text-uppercase">{{ __('Ranks') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 active" href="{{ route('teacher.turnin') }}">
                            <i class="fs-4 fa-solid fa-users px-3 mt-2"></i>
                            <span class="px-1 text-uppercase">{{ __('Turned in') }}</span>
                        </a>
                    </li>
                    </ul>
                </div>
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-auto mb-0 align-items-start" id="menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('teacher.class.home',$classes->uuid) }}" class="nav-link text-truncate text-dark">
                                <i class="fs-5 bi bi-menu-button-wide-fill text-dark"></i>
                                <span class="ms-3 text-truncate" aria-current="page">{{ __( $classes->subject. ' - ' .$classes->yearLevel.'' .$classes->section) }}</span>
                            </a>
                        </li>
                        @endforeach
                    </ul>
