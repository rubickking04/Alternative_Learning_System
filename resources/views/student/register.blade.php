@extends('student.layouts.register')
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-xl-7">
            <div class="py-3">
                ...
                <hr>
                <h3 class="text-center py-4 fw-bold text-uppercase" style="letter-spacing: 3px">{{ __('Register Account') }}</h3>
                ...
                </div><div class="text-start lh-sm">
                    <p>Want to create your courses? <a href="{{ route('student.login') }}">{{ __('Click here') }}</a></p>
                </div>
            </div>
        </div>
    </div>
